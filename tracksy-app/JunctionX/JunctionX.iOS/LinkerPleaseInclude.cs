...
namespace JunctionX.iOS
{
    ...
    public class LinkerPleaseInclude
    {
        ...
        public void Include(MvvmCross.Plugin.MethodBinding.Plugin plugin)
        {
            plugin = new MvvmCross.Plugin.MethodBinding.Plugin();
        }
        public void Include(MvvmCross.Plugin.MethodBinding.MvxMethodSourceBinding plugin, Object obj, System.Reflection.MethodInfo methodInfo) 
        {
            plugin = new MvvmCross.Plugin.MethodBinding.MvxMethodSourceBinding(obj, methodInfo);
        }
        public void Include(MvvmCross.Plugin.MethodBinding.MvxMethodSourceBindingFactoryExtension plugin)
        {
            plugin = new MvvmCross.Plugin.MethodBinding.MvxMethodSourceBindingFactoryExtension();
        }
        public void Include(MvvmCross.Plugin.Visibility.Platforms.Ios.MvxIosVisibility mvxIosVisibility)
        {
            mvxIosVisibility = new MvvmCross.Plugin.Visibility.Platforms.Ios.MvxIosVisibility();
        }
